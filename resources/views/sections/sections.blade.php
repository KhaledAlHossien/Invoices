        ...
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                ...
                <div class="col-sm-6 col-md-4 col-xl-3 mg-t-20">
                    <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-flip-horizontal" data-toggle="modal" href="#modaldemo8">Add section</a>
            </div>
                ...
                <div class="table-responsive">
                    <table id="example1" class="table key-buttons text-md-nowrap">
                        ...
                        <tr>
                            ...
                            <th class="border-bottom-0">Sections name</th>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <form action="sections/destroy" method="post">
                ...
                {{ csrf_field() }}
                <div class="modal-body">
                    <p>Are you sure you want delete it ?</p><br>
                    <input type="hidden" name="id" id="id" value="">
